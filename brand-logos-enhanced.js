...
const brandLogos = {
    ...
    "Chigo": {
        logo: "https://logo.clearbit.com/chigo.com.cn?size=200",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=C"
    },
    "AUX": {
        logo: "https://logo.clearbit.com/aux.com.cn?size=200",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=A"
    },
    "Daikin": {
        logo: "https://logo.clearbit.com/daikin.com?size=200",
    ...
    "Mitsubishi Electric": {
        logo: "https://logo.clearbit.com/mitsubishielectric.com?size=200",
    ...
    "Hitachi": {
        logo: "https://logo.clearbit.com/hitachi.com?size=200",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=H"
    },
    "Toshiba": {
...
function getBrandLogo(brandName) {
    ...
    const domain = clearbitUrl.replace('https://logo.clearbit.com/', '').replace('?size=200', '');
    
    // Try multiple logo paths for better success rate
    const logoPaths = [
        brandData.logo, // Clearbit logo with size
        `https://logo.clearbit.com/${domain}`, // Clearbit without size
...
function createBrandLogoImage(brandName) {
    ...
    img.onload = function() {
        ...
        console.log(`✅ Logo loaded successfully for ${brandName}`);
    };
    
    // Error handling with multiple fallback options
    let fallbackIndex = 0;
    img.onerror = function() {
        console.log(`❌ Logo failed to load for ${brandName}, trying fallback ${fallbackIndex + 1}`);
        ...
        if (logoData.alternatives && fallbackIndex < logoData.alternatives.length) {
            ...
            this.style.opacity = '1';
            console.log(`🔄 Using placeholder for ${brandName}`);
        }
    };
