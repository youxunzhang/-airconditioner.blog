...
const brandLogos = {
    ...
    "Mitsubishi Heavy Industries": {
        logo: "https://www.mhi.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=MHI"
    },
    "Mitsubishi Electric": {
        logo: "https://www.mitsubishielectric.com/favicon.ico",
    ...
    "Hitachi": {
        logo: "https://www.hitachi.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=H"
    },
    "Toshiba": {
        logo: "https://www.toshiba.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=T"
    },
    "Fujitsu": {
        logo: "https://www.fujitsu.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=F"
    },
    "Sharp": {
        logo: "https://www.sharp.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=S"
    },
    "York": {
    ...
    "Trane": {
        logo: "https://www.trane.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=T"
    },
    "Lennox": {
        logo: "https://www.lennox.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=L"
    },
    "Rheem": {
        logo: "https://www.rheem.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=R"
    },
    "Goodman": {
        logo: "https://www.goodmanmfg.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=G"
    },
    "Bryant": {
        logo: "https://www.bryant.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=B"
    },
    "American Standard": {
        logo: "https://www.americanstandardair.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=AS"
    },
    "Amana": {
        logo: "https://www.amana-hac.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=A"
    },
    "Frigidaire": {
        logo: "https://www.frigidaire.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=F"
    },
    "Whirlpool": {
        logo: "https://www.whirlpool.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=W"
    },
    "GE Appliances": {
        logo: "https://www.geappliances.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=GE"
    },
    "Maytag": {
        logo: "https://www.maytag.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=M"
    },
    "Kenmore": {
        logo: "https://www.kenmore.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=K"
    },
    "Bosch": {
        logo: "https://www.bosch-climate.com/favicon.ico",
        fallback: "https://via.placeholder.com/200x200/667eea/ffffff?text=B"
    },
    "Sanyo": {
...
function getBrandLogo(brandName) {
    ...
    const logoPaths = [
        brandData.logo,
        brandData.logo.replace('/favicon.ico', '/logo.png'),
        brandData.logo.replace('/favicon.ico', '/logo.jpg'),
        brandData.logo.replace('/favicon.ico', '/favicon.png'),
        brandData.fallback
    ];
